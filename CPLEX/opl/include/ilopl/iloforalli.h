...
class IloSymbolIndexI : public IloSymbolExprI{
  ILOEXTRDECL
    IloExtractableI* makeClone(IloEnvI* env) const ILO_OVERRIDE;
public:
...
public:
  ...
  virtual void checkCompatibility(IloTupleSchemaI const *) const;
  virtual void setKeyProperty(IloBool flag) { _isKey = flag; }
  IloBool isKey() const{ return _isKey; }
  virtual void display(ILOSTD(ostream)& out) const ILO_OVERRIDE;
  virtual IloBool isTupleIndex() const ILO_OVERRIDE { return IloTrue;}
  virtual void visitSubExtractables(IloExtractableVisitor* v) ILO_OVERRIDE;
  virtual IloBool hasNongroundType() const ILO_OVERRIDE;
...
public:
  ...
  virtual void checkCompatibility(IloTupleSchemaI const *schema) const ILO_OVERRIDE;
  void checkColumnCompatibility(IloTuplePatternItem* item,
    IloColumnDefinitionI const *col, IloInt pos) const;
  void lockSubExpr();
  ...
  ILOEXTROTHERDECL
  virtual void setKeyProperty(IloBool flag) ILO_OVERRIDE;
  virtual IloBool isTupleIndex() const ILO_OVERRIDE { return IloFalse; }
  virtual IloBool isTuplePattern() const ILO_OVERRIDE { return IloTrue; }
  void getItemNames(IloStringArray arr);
  void flattenPattern(IloAdvModelEvaluatorI* e, IloMapIndexArray arr);
  virtual void setSchema(IloTupleSchemaI const *schema) ILO_OVERRIDE;
...
public:
  ...
  IloInt getIndexKey() const ILO_OVERRIDE;
...
public:
  ...
  ILOEXTROTHERDECL
  virtual IloBool isAggregate() const ILO_OVERRIDE { return IloTrue; }
};
...
public:
  ...
  virtual IloInt expandTo(IloNumExprI* e) const ILO_OVERRIDE;
