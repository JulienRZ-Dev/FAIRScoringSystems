...
protected:
    ...
    virtual IloBool isInSection(Section section) const ILO_OVERRIDE;
...
public:
    ...
    virtual void printReport(std::ostream& os) ILO_OVERRIDE;
    IloBool hasRoot() const;
    const Node& getRoot() const;

    virtual void enterSection(Section section, const char* name) ILO_OVERRIDE;
    virtual void reenterSection(Section section, const char* name) ILO_OVERRIDE;
    virtual void exitSection(Section section) ILO_OVERRIDE;

    virtual void enterInit(const char* name) ILO_OVERRIDE;
    virtual void exitInit (const char* name) ILO_OVERRIDE;

    virtual void enterExecute(const char* name) ILO_OVERRIDE;
    virtual void exitExecute(const char* name) ILO_OVERRIDE;

    virtual void setLocation(const IloOplLocationI& location) ILO_OVERRIDE;
};
...
public:
  ...
  virtual void notifyEnterSection(IloOplProfilerI::Section section, const char* qualifier, IloNum time) ILO_OVERRIDE;
  virtual void notifyExitSection (IloOplProfilerI::Section section, const char* qualifier, IloNum time) ILO_OVERRIDE;
...
protected:
  ...
  virtual void traceEnter(Section section, const char* qualifier) ILO_OVERRIDE;
  virtual void traceExit (Section section, const char* qualifier) ILO_OVERRIDE;
...
public:
  ...
  virtual IloBool acceptsListener() const ILO_OVERRIDE;

  
  virtual void setListener(IloOplProgressListenerI* listener, IloBool ownership) ILO_OVERRIDE;

  
  virtual IloOplProgressListenerI* getListener() const ILO_OVERRIDE;

  virtual IloBool ownsListener() const ILO_OVERRIDE { return _ownsListener;}
