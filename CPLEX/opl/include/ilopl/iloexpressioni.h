...
class IloConditionalIntExprI : public IloConditionalExprI< IloIntExprI, IloConditionalIntExprI > {
  ILOEXTRDECL
public:
  IloConditionalIntExprI(IloEnvI* env, IloConstraintI* cond, IloIntExprI* left, IloIntExprI* right )
    : IloConditionalExprI< IloIntExprI, IloConditionalIntExprI >( env, cond, left, right ) {}
...
class IloConditionalNumExprI: public IloConditionalExprI< IloNumExprI, IloConditionalNumExprI > {
  ILOEXTRDECL
public:
  IloConditionalNumExprI(IloEnvI* env, IloConstraintI* cond, IloNumExprI* left, IloNumExprI* right )
    : IloConditionalExprI< IloNumExprI, IloConditionalNumExprI >( env, cond, left, right ) {}
