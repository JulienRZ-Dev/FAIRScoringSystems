...
public:
  ...
  ILOEXTROTHERDECL
  IloDiscreteDataCollectionI* getDiscreteDataCollection() const ILO_OVERRIDE;
...
public:
  ...
  virtual void reset(IloInt min, IloInt max, IloBool catchInvalidCollection = IloFalse) ILO_OVERRIDE;
};
...
class IloConditionalIntSetExprI
  : public IloConditionalExprI< IloIntCollectionExprI, IloConditionalIntSetExprI > {
  ILOEXTRDECL

public:
  IloConditionalIntSetExprI(IloEnvI* env, IloConstraintI* cond, IloIntCollectionExprI* left, IloIntCollectionExprI* right )
    : IloConditionalExprI< IloIntCollectionExprI, IloConditionalIntSetExprI >( env, cond, left, right ) {}
