...
template<typename T>
struct IloCompareResult {
  static IloNum convert(T const &t) { return t; }
};
template<> struct IloCompareResult<IloInt> {
  static IloNum convert(IloInt const &i) { return IloInt2Num(i); }
};
...
public:
  IloNum compare( T left, T right ) {
    return IloCompareResult<T>::convert(left - right);
  }
};
...
public:
  ...
  virtual IloNum compare( IloElementComparator* c ) const ILO_OVERRIDE {
  ...
  virtual IloInt getSize() const ILO_OVERRIDE { return sizeof( IloSymbolComparator ); }
...
public:
  ...
  virtual IloNum compare( IloAny c ) const ILO_OVERRIDE {
    return -1 * IloSymbolElementComparator::compare( c );
  }
};
...
public:
  ...
  virtual IloNum compare( T c ) const {
    return IloCompareResult<T>::convert(_value - c);
  }

  virtual IloInt getSize() const ILO_OVERRIDE { return sizeof( IloNumberElementComparator< T > ); }
...
public:
  ...
  virtual IloNum compare( T c ) const ILO_OVERRIDE {
    return -1 * IloNumberElementComparator<T>::compare( c );
  }
};
...
public:
  ...
  virtual IloNum compare( const IloTupleI* tuple ) const {
    ...
    IloTupleSchemaI const *schema = getValue().getImpl()->getSchema();
  ...
  virtual IloInt getSize() const ILO_OVERRIDE { return sizeof( IloTupleElementComparator ); }
...
public:
  ...
  virtual IloNum compare( const IloTupleI* tuple ) const ILO_OVERRIDE {
...
public:
  ...
  virtual IloInt getSize() const ILO_OVERRIDE { return sizeof( IloTupleCellArrayElementComparator ); }
...
public:
  ...
  virtual IloNum compare( const IloTupleCellArray& tupleCellArray ) const ILO_OVERRIDE {
