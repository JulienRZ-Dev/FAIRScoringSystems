...
public:
	...
	virtual IloInt getCumulValue( IloBool& isObsolete, const IloCumulFunctionExprArg cumulFct, const IloModelEvaluatorSolutionGetterBaseI::FunctionField field, const IloInt pos = -1 ) const {
	  return 0;
	}
...
public:
    ...
    virtual IloBool isSolutionAvailable() const ILO_OVERRIDE {
        return _delegate->isSolutionAvailable();
    }
    virtual IloBool isIntermediateSolution() const ILO_OVERRIDE {
        return _delegate->isIntermediateSolution();
    }
    virtual IloBool getWarnObsolete() const ILO_OVERRIDE {
        return _delegate->getWarnObsolete();
    }
    virtual IloInt getIntValue(IloIntVar var) const ILO_OVERRIDE { 
        return _delegate->getIntValue(var); 
    }
    virtual IloNum getNumValue(IloNumVar var) const ILO_OVERRIDE { 
        return _delegate->getNumValue(var); 
    }       
    virtual IloBool hasSlack(IloConstraint ct) const ILO_OVERRIDE { 
        return _delegate->hasSlack(ct); 
    }       
    virtual IloNum getSlack(IloConstraint ct) const ILO_OVERRIDE { 
        return _delegate->getSlack(ct); 
    }       
    virtual IloBool hasDual(IloConstraint ct) const ILO_OVERRIDE { 
        return _delegate->hasDual(ct); 
    }       
    virtual IloNum getDual(IloConstraint ct) const ILO_OVERRIDE { 
        return _delegate->getDual(ct); 
    }       
    virtual IloBool hasReducedCost(IloNumVar var) const ILO_OVERRIDE { 
        return _delegate->hasReducedCost(var); 
    }       
    virtual IloNum getReducedCost(IloNumVar var) const ILO_OVERRIDE { 
        return _delegate->getReducedCost(var); 
    }       
	
	virtual IloBool hasObjValue() const ILO_OVERRIDE { 
        return _delegate->hasObjValue(); 
    }       
    virtual IloNum getObjValue() const ILO_OVERRIDE { 
	...
	virtual IloInt getIntervalValue( const IloIntervalVar dvar, const IloModelEvaluatorSolutionGetterBaseI::IntervalField field ) const ILO_OVERRIDE {
		return _delegate->getIntervalValue(dvar,field);
	}
	
	virtual IloIntervalVar getSequenceValue( const IloIntervalSequenceVar seq, const IloIntervalVar a, const IloModelEvaluatorSolutionGetterBaseI::SequenceDirection direction = IloModelEvaluatorSolutionGetterBaseI::LeftToRight ) const ILO_OVERRIDE {
		return _delegate->getSequenceValue( seq, a, direction );
	}
	virtual IloInt getCumulValue( const IloCumulFunctionExprArg cumulFct, const IloModelEvaluatorSolutionGetterBaseI::FunctionField field, const IloInt pos = -1 ) const ILO_OVERRIDE {
...
class ILOOPL_EXPORTED IloOplModelI : public IloDestroyableI {
  ...
  struct TableHandler {
    IloOplTableDataHandlerI *_handler;
    IloOplDll *_dll;
    TableHandler(IloOplTableDataHandlerI *h = 0, IloOplDll *d = 0)
      : _handler(h), _dll(d) {}
  };
  IloArray<TableHandler> _tableHandlerList;

  friend class IloOplTableDataHandlerI;
  void addTableResultPublisher(IloOplResultPublisherI* publisher);

  void init();
  void initCustomDataHandlerRegistry();
  void clearCustomDataHandlerRegistry();
  void initTableHandlerRegistry();
  void clearTableHandlerRegistry();
  void publishResults();
...
public:
    ...
    IloCplexI& getCplex() const ILO_OVERRIDE;

    virtual IloBool hasCplex() const ILO_OVERRIDE {
        return IloTrue;
    }

protected:
    virtual IloOplSolutionGetterI* newDefaultSolutionGetter() const ILO_OVERRIDE;
    virtual IloOplSolutionGetterI* newDefaultSolutionPoolGetter() const ILO_OVERRIDE;
};
...
public:
    ...
    IloCPI& getCP() const ILO_OVERRIDE;

    virtual IloBool hasCP() const ILO_OVERRIDE {
        return IloTrue;
    }
	virtual void removeAlgorithm(IloAlgorithmI* alg) ILO_OVERRIDE;

protected:
    virtual IloOplSolutionGetterI* newDefaultSolutionGetter() const ILO_OVERRIDE;
    virtual IloOplSolutionGetterI* newDefaultSolutionPoolGetter() const ILO_OVERRIDE;
public:
	virtual void removePrinter(IloAlgorithmI* alg) ILO_OVERRIDE;
};
...
public:
    ...
    virtual IloXmlElement* getConfigs() const ILO_OVERRIDE;
    virtual IloXmlElement* getConfig(const char* name) const ILO_OVERRIDE;
    virtual IloXmlElement* getDefaultConfig() const ILO_OVERRIDE;

    virtual void getReferencesByType(IloXmlElement* config, const char* tname, ElementArray& result) ILO_OVERRIDE;
};
...
class ILOOPL_EXPORTED IloOplScriptExpressionI: public IloOplScriptThunkI {
	...
	virtual IloBool usesSharedContext() const ILO_OVERRIDE {
		return IloTrue;
	}
	virtual IloBool hasParameterNames() const ILO_OVERRIDE {
		return _paramNames.getImpl()!=0 && _paramNames.getSize()>0;	
	}
	virtual const IloStringArray getParamterNames() const ILO_OVERRIDE {
		return _paramNames;
	}
...
class ILOOPL_EXPORTED IloOplCplexFeasOptIteratorI: public IloOplRelaxationIteratorI {
    ...
    virtual void visitPairs() ILO_OVERRIDE;
    virtual void add(IloConstraintI*, IloNum) ILO_OVERRIDE;
...
public:
    ...
    virtual IloBool hasPossibleConstraints() const ILO_OVERRIDE;

    virtual void recalculate() ILO_OVERRIDE;

    virtual void firstRelaxed() ILO_OVERRIDE;
    virtual IloBool hasRelaxed() ILO_OVERRIDE;
    virtual void nextRelaxed() ILO_OVERRIDE;

    virtual IloExtractable currentRelaxed() const ILO_OVERRIDE;
    virtual const char* currentName() const ILO_OVERRIDE;
    virtual IloBool isCurrentRanged()const ILO_OVERRIDE;
    virtual IloNum currentInfeas()const ILO_OVERRIDE;
    virtual IloNum currentLB()const ILO_OVERRIDE;
    virtual IloNum currentUB()const ILO_OVERRIDE;
    virtual IloNum currentRelaxedLB() const ILO_OVERRIDE;
    virtual IloNum currentRelaxedUB() const ILO_OVERRIDE;
    virtual IloConstraint currentRelaxedConstraint() const ILO_OVERRIDE;
};
...
class ILOOPL_EXPORTED IloOplCplexConflictIteratorI: public IloOplConflictIteratorI {
    ...
    virtual void reattach() ILO_OVERRIDE {
        _attached = IloFalse;
        recalculate();
    }
    virtual void recalculate() ILO_OVERRIDE {
    ...
    void exclude(IloConstraintI*) ILO_OVERRIDE;
...
public:
	...
	virtual IloBool hasPossibleConstraints() const ILO_OVERRIDE;
    virtual IloBool hasFoundConflict() ILO_OVERRIDE;    

    virtual IloInt printConflict(std::ostream& os) ILO_OVERRIDE;
    void excludeConflict() ILO_OVERRIDE;

    virtual void firstInConflict() ILO_OVERRIDE;
    virtual IloBool isInConflict() const ILO_OVERRIDE;
    virtual void nextInConflict() ILO_OVERRIDE;
    virtual IloExtractable currentInConflict() const ILO_OVERRIDE;
    virtual ConflictStatus currentConflictStatus() const ILO_OVERRIDE;
...
class ILOOPL_EXPORTED IloOplCustomDataHandlerI: public IloRttiEnvObjectI {
  ...
  IloOplDataSourceI const *_currentDataSource;
  ...
  void setCurrentDataSource(IloOplDataSourceI const *src) { _currentDataSource = src; }
  ...
  char const *getCustomId() const { return _customId; }

  IloOplDataSourceI const *getCurrentDataSource() const { return _currentDataSource; }
...
public:
    ...
    virtual void process(const IloOplModelI& opl, IloNumExprI* dexpr) ILO_OVERRIDE;

    virtual IloBool startDecisionExpr(const char* dexprName, IloNum coef, IloNumExprArg expr) ILO_OVERRIDE;
    virtual IloBool startSum(IloNum coef, IloNumExprArg expr) ILO_OVERRIDE;
    virtual void addTerm(IloNum coef, IloNumExprArg dexpr) ILO_OVERRIDE;
    ...
    virtual void endSum() ILO_OVERRIDE =0;
    virtual void endDecisionExpr(const char* dexprName) ILO_OVERRIDE =0;
