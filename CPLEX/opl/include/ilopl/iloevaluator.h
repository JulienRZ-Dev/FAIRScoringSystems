...
class IloAggregateSegmentedFunctionI; 
class IloCumulAtomI;
...
public:
  ...
  IloMismatchDExprSubstitution()
    : IloException("Can not mix pattern and index between declaration of dexpr and instantiation"), _expr(0), _indexes(), _values(){}
