...
class IloConditionalSymbolExprI : public IloConditionalExprI< IloSymbolExprI, IloConditionalSymbolExprI >  {

  ILOEXTRDECL
public:
  IloConditionalSymbolExprI(IloEnvI* env, IloConstraintI* cond, IloSymbolExprI* left, IloSymbolExprI* right )
    : IloConditionalExprI< IloSymbolExprI, IloConditionalSymbolExprI >( env, cond, left, right ) {}
