...
public:
    ...
    void read() const ILO_OVERRIDE;
    const char* getDataSourceName() const ILO_OVERRIDE;
    const IloOplLocationI& getCurrentLocation() const ILO_OVERRIDE;
};
...
protected:
    ...
    void printTupleItem(const IloTuple& tuple, IloInt index, IloTupleSchemaI const *schema);
...
public:
    ...
    virtual void startElement(const char* name, IloBool restart =IloFalse) ILO_OVERRIDE;    
    virtual void endElement() ILO_OVERRIDE;    

    virtual void setElement(IloOplElementI& element) ILO_OVERRIDE;
	virtual void invoke(const char* name, const char* funcName) ILO_OVERRIDE;

    virtual void startArray() ILO_OVERRIDE;    
    virtual void endArray() ILO_OVERRIDE;    

    virtual void startIndexedArray() ILO_OVERRIDE;    
    virtual void endIndexedArray() ILO_OVERRIDE;    

    virtual void startTuple() ILO_OVERRIDE;    
    virtual void endTuple() ILO_OVERRIDE;    

    virtual void startNamedTuple() ILO_OVERRIDE;    
    virtual void endNamedTuple() ILO_OVERRIDE;    

    virtual void startSet() ILO_OVERRIDE;    
    virtual void endSet() ILO_OVERRIDE;    

    virtual void setItemIntIndex(IloInt  value) ILO_OVERRIDE;    
    virtual void setItemNumIndex(IloNum value) ILO_OVERRIDE;    
    virtual void setItemStringIndex(const char* value) ILO_OVERRIDE;    

    virtual void setItemName(const char* name) ILO_OVERRIDE;    

    virtual void startItemTupleIndex() ILO_OVERRIDE;    
    virtual void endItemTupleIndex() ILO_OVERRIDE;    
    void endItemTupleIndex(IloBool separate);

    virtual void addIntItem(IloInt  value) ILO_OVERRIDE;    
    virtual void addNumItem(IloNum value) ILO_OVERRIDE;    
    virtual void addStringItem(const char* value) ILO_OVERRIDE;    

    virtual IloOplElementI& getElement(const char* name) const ILO_OVERRIDE;

	virtual void executePrepare(const char* block) ILO_OVERRIDE;
	virtual void executePrepare(IloOplScriptThunkI& prepare) ILO_OVERRIDE;
