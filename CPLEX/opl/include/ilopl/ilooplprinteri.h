...
class IloMapExprAsNumCollectedMapI;
...
#ifdef ILO_SCHED_OBJ
class IlosObjectiveI; 
#endif
class IlosCostToNumExprI;
class IloFunctionExprI; 
...
public:
    ...
    void printIloMapExprAsNumCollectedMapI(const IloMapExprAsNumCollectedMapI* e);
	...
	void printIloConditionalPiecewiseFunctionExprI(const IloConditionalPiecewiseFunctionExprI* e);
