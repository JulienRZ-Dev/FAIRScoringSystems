...
protected:
  ...
  IloAbstractTupleMapI(IloEnvI* env, IloDiscreteDataCollectionI* indexer, IloTupleSchemaI const *schema, IloInt size);
...
public:
  ...
  IloTupleSchemaI const *getSchema() const { return _coll->getSchema();}
  ...
  IloInt getAbsoluteIndex(IloAny idx, IloInt dim = 0) const {
    IloOplAssert(getIndexer(dim),"Using IloTupleMap/IloTupleMap without indexer");
...
public:
  ...
  virtual void setAtAbsoluteIndex(IloIntFixedArray indices, IloOplObject value) ILO_OVERRIDE=0;
  ...
  virtual IloOplObject getAtAbsoluteIndex(IloIntFixedArray indices) const ILO_OVERRIDE = 0;
  ...
  virtual void setAt(IloMapIndexArray indices, IloOplObject value) ILO_OVERRIDE = 0;

  virtual IloOplObject getAt(IloMapIndexArray indices) const ILO_OVERRIDE = 0;
...
public:
  ...
  virtual IloAbstractTupleMapI* getCopy() const ILO_OVERRIDE;
  virtual IloAbstractTupleMapI* makeClone(IloEnvI* env) const ILO_OVERRIDE;
  IloTupleMapI(IloEnvI* env, IloIntMap indices, IloTupleSchemaI const *schema);
  IloTupleMapI(IloEnvI* env, IloIntMap indices, IloTupleCollectionI* coll);

  virtual IloInt getNbDim() const ILO_OVERRIDE { return getIndImpl()->getNbDim(); }
  
  virtual IloInt getTotalSize() ILO_OVERRIDE { return getIndImpl()->getTotalSize(); }
  virtual IloInt getSize() const ILO_OVERRIDE { return getIndImpl()->getSize(); }
  virtual const char* getName() const ILO_OVERRIDE { return getIndImpl()->getName(); }
  virtual void setName(const char* name) ILO_OVERRIDE { getIndImpl()->setName(name); }
  ...
  void setAt(IloMapIndexArray indices, IloTuple value) ILO_OVERRIDE;
  void setAt(IloMapIndexArray indices, IloTupleBuffer value) ILO_OVERRIDE;
  ...
  void getAt(IloMapIndexArray indices, IloTuple tuple) const ILO_OVERRIDE;
  void getAt(IloMapIndexArray indices, IloTupleBuffer buffer) const ILO_OVERRIDE;

  using IloAbstractTupleMapI::setAtAbsoluteIndex;
  using IloAbstractTupleMapI::getAtAbsoluteIndex;
  void setAtAbsoluteIndex(IloIntFixedArray indices, IloTuple value) ILO_OVERRIDE;
  void setAtAbsoluteIndex(IloIntFixedArray indices, IloTupleBuffer value) ILO_OVERRIDE;
  ...
  void getAtAbsoluteIndex(IloIntFixedArray indices, IloTuple tuple) const ILO_OVERRIDE;
  void getAtAbsoluteIndex(IloIntFixedArray indices, IloTupleBuffer buffer) const ILO_OVERRIDE;
