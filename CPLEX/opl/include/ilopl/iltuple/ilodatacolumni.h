...
public:
  ...
  virtual IloBool hasReference() const ILO_OVERRIDE {  return _refered != 0; }
  ...
  inline IloIntArray getArray() const ILO_OVERRIDE {return _array;}
  virtual IloIntArray makeIndexArray(IloInt value) const ILO_OVERRIDE;
  ...
  IloBool contains(IloInt elt) const ILO_OVERRIDE;
  IloInt getValue(IloInt index) const ILO_OVERRIDE;
  inline virtual IloDataCollection::IloDataType getDataType() const ILO_OVERRIDE {
    return IloDataCollection::IntDataColumn;
  }
  IloBool isIntDataColumn() const ILO_OVERRIDE;
...
public:
  ...
  inline IloNumArray getArray() const ILO_OVERRIDE {return _array;}
  IloInt getSize() const ILO_OVERRIDE {
    return _array.getImpl() ? _array.getSize() : 0;
  }
  virtual IloObjectBase getMapItem(IloInt idx) const ILO_OVERRIDE;
  ...
  IloNum getNumValue(IloInt idx) const ILO_OVERRIDE;
  IloInt getIntValue(IloInt idx) const ILO_OVERRIDE;
  virtual IloIntArray makeIndexArray(IloNum value) const ILO_OVERRIDE;
  void add(IloNum elt);
  void add(IloNumDataColumnI* set);
  void empty() ILO_OVERRIDE;
  IloBool contains(IloNum elt) const ILO_OVERRIDE;
  IloNum getValue(IloInt index) const ILO_OVERRIDE;
  inline virtual IloDataCollection::IloDataType getDataType() const ILO_OVERRIDE {
    return IloDataCollection::NumDataColumn;
  }
  IloBool isNumDataColumn() const ILO_OVERRIDE;
  void display(ILOSTD(ostream)& os) const ILO_OVERRIDE;
...
public:
  ...
  inline IloAnyArray getArray() const ILO_OVERRIDE {return _array;}
  IloInt getSize() const ILO_OVERRIDE {
    return _array.getImpl() ? _array.getSize() : 0;
  }
  virtual IloObjectBase getMapItem(IloInt idx) const ILO_OVERRIDE;
  ...
  virtual void empty() ILO_OVERRIDE;
  IloBool contains(IloAny elt) const ILO_OVERRIDE;
  IloAny getValue(IloInt index) const ILO_OVERRIDE;

  inline virtual IloDataCollection::IloDataType getDataType() const ILO_OVERRIDE {
    return IloDataCollection::AnyDataColumn;
  }
  IloBool isAnyDataColumn() const ILO_OVERRIDE;
  void display(ILOSTD(ostream)& os) const ILO_OVERRIDE;
