...
public:
  ...
  virtual IloIntArrayI* execute() ILO_OVERRIDE;
  
  virtual IloBool store(IloIntArrayI* slice) ILO_OVERRIDE;
};
...
public:
  ...
  virtual IloInt execute() ILO_OVERRIDE;
  
  virtual IloBool store(IloInt slice) ILO_OVERRIDE;
};
