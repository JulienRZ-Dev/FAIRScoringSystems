...
public:
  ...
  void setCollection(IloTupleCollectionI* coll, IloBool reg = IloTrue);
  
  const IloTupleCollectionI* getCollection() const { return _coll; }

  
  IloTupleSchemaI const *getSchema() const;
  ...
  virtual IloBool isEnvAllocated() const { return IloTrue; }
  ...
  protected:
  IloTupleI(IloEnvI* env, IloTupleCollectionI* coll, IloInt i, IloBool x);
  public:
  virtual void clear();
};

class IloEvalTupleI : public IloTupleI{
public:
  IloEvalTupleI(IloEnvI* env, IloTupleCollectionI* coll, IloInt i=-1);
  virtual ~IloEvalTupleI(){}
  virtual IloBool isEnvAllocated() const ILO_OVERRIDE { return IloFalse; }
};
...
protected:
 ...
 public:
   ...
   IloTupleSchema getSchema() const {
     IloOplAssert(getImpl(), "Using empty IloTuple handle");
   ...
   void setCollection(IloTupleCollection coll);
...
inline ILOSTD(ostream)& operator<<(ILOSTD(ostream)& out, const IloTuple& t){
  IloOplAssert(t.getImpl(), "Use empty handle.");
...
public:
  ...
  virtual IloInt getIntValue(const char* col) const ILO_OVERRIDE;

  
  virtual IloNum getNumValue(const char* col) const ILO_OVERRIDE;

  
  virtual IloAny getAnyValue(const char* col) const ILO_OVERRIDE;

  
  virtual IloSymbol getSymbolValue(const char* col) const ILO_OVERRIDE;

  
  virtual const char* getStringValue(const char* col) const ILO_OVERRIDE;

  
  virtual IloTupleI* makeTupleValue(const char* col) const ILO_OVERRIDE;

  
  virtual IloIntCollectionI* getIntCollectionValue(const char* col) const ILO_OVERRIDE;

  
  virtual IloNumCollectionI* getNumCollectionValue(const char* col) const ILO_OVERRIDE;

  
  virtual IloAnyCollectionI* getAnyCollectionValue(const char* col) const ILO_OVERRIDE;

  
  virtual IloInt getIntValue(IloInt index) const ILO_OVERRIDE;

  
  virtual IloNum getNumValue(IloInt index) const ILO_OVERRIDE;

  
  virtual IloAny getAnyValue(IloInt index) const ILO_OVERRIDE;

  
  virtual IloIntCollectionI* getIntCollectionValue(IloInt index) const ILO_OVERRIDE;

  
  virtual IloNumCollectionI* getNumCollectionValue(IloInt index) const ILO_OVERRIDE;

  
  virtual IloAnyCollectionI* getAnyCollectionValue(IloInt index) const ILO_OVERRIDE;

  
  virtual IloSymbol getSymbolValue(IloInt index) const ILO_OVERRIDE;

  
  virtual const char* getStringValue(IloInt index) const ILO_OVERRIDE;

  
  virtual IloTupleI* makeTupleValue(IloInt index) const ILO_OVERRIDE;

  
  
  virtual IloInt getIntValue(IloIntArray path) const ILO_OVERRIDE;

  
  virtual IloNum getNumValue(IloIntArray path) const ILO_OVERRIDE;

  
  virtual IloAny getAnyValue(IloIntArray path) const ILO_OVERRIDE;

  
  virtual IloIntCollectionI* getIntCollectionValue(IloIntArray path) const ILO_OVERRIDE;

  
  virtual IloNumCollectionI* getNumCollectionValue(IloIntArray path) const ILO_OVERRIDE;

  
  virtual IloAnyCollectionI* getAnyCollectionValue(IloIntArray path) const ILO_OVERRIDE;

  
  virtual IloSymbol getSymbolValue(IloIntArray path) const ILO_OVERRIDE;

  
  virtual const char* getStringValue(IloIntArray path) const ILO_OVERRIDE;

  
  virtual IloTupleI* makeTupleValue(IloIntArray path) const ILO_OVERRIDE;
  ...
  virtual IloBool isTupleBuffer() const ILO_OVERRIDE { return IloTrue; }
  virtual IloOplObject getMapItem(IloIntArray path) const ILO_OVERRIDE;
  virtual IloTupleCellArray makeTupleCells() ILO_OVERRIDE;
  virtual IloTupleI* makeClone(IloEnvI* env) const ILO_OVERRIDE;
};
...
class IloConditionalTupleExprI
  : public IloConditionalExprI< IloTupleExprI, IloConditionalTupleExprI >  {

  ILOEXTRDECL

public:
  IloConditionalTupleExprI(IloEnvI* env, IloConstraintI* cond, IloTupleExprI* left, IloTupleExprI* right )
    : IloConditionalExprI< IloTupleExprI, IloConditionalTupleExprI >( env, cond, left, right ) {
