...
public:
    ...
    virtual void startElement(const char* name, IloBool) ILO_OVERRIDE =0;

    
    virtual void endElement() ILO_OVERRIDE =0;

    
    virtual void setElement(IloOplElementI& element) ILO_OVERRIDE =0;

    
    virtual void invoke(const char* , const char* ) ILO_OVERRIDE {
    }

    
    virtual void startArray() ILO_OVERRIDE =0;

    
    virtual void endArray() ILO_OVERRIDE =0;

    
    virtual void startIndexedArray() ILO_OVERRIDE =0;

    
    virtual void endIndexedArray() ILO_OVERRIDE =0;

    
    virtual void startTuple() ILO_OVERRIDE =0;

    
    virtual void endTuple() ILO_OVERRIDE =0;

    
    virtual void startNamedTuple() ILO_OVERRIDE =0;

    
    virtual void endNamedTuple() ILO_OVERRIDE =0;

    
    virtual void startSet() ILO_OVERRIDE =0;

    
    virtual void endSet() ILO_OVERRIDE =0;

    
    virtual void setItemIntIndex(IloInt  value) ILO_OVERRIDE  =0;

    
    virtual void setItemNumIndex(IloNum value) ILO_OVERRIDE  =0;

    
    virtual void setItemStringIndex(const char* value) ILO_OVERRIDE  =0;

    
    virtual void startItemTupleIndex() ILO_OVERRIDE =0;

    
    virtual void endItemTupleIndex() ILO_OVERRIDE =0;

    
    virtual void setItemName(const char* name) ILO_OVERRIDE =0;

    
    virtual void addIntItem(IloInt  value) ILO_OVERRIDE =0;

    
    virtual void addNumItem(IloNum value) ILO_OVERRIDE =0;

    
    virtual void addStringItem(const char* value) ILO_OVERRIDE =0;

    
    virtual IloOplElementI& getElement(const char* name) const ILO_OVERRIDE =0;

    
    virtual void executePrepare(const char* ) ILO_OVERRIDE {
    }

    
    virtual void executePrepare(IloOplScriptThunkI& ) ILO_OVERRIDE {
    }
};
...
public:
    ...
    virtual void read() const ILO_OVERRIDE =0;

    
    virtual const char* getDataSourceName() const ILO_OVERRIDE {
