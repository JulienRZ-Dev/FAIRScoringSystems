...
public:
    ...
    virtual void publish() ILO_OVERRIDE =0;

    
    virtual const char* getResultPublisherName() const ILO_OVERRIDE =0;
};
...
public:
    ...
    virtual IloBool isSolutionAvailable() const ILO_OVERRIDE =0;

    
    virtual IloInt getIntValue(IloIntVar var) const ILO_OVERRIDE =0;

    
    virtual IloNum getNumValue(IloNumVar var) const ILO_OVERRIDE =0;
};
...
public:
    ...
    IloNum getRelaxedLB() const {
      return impl().currentRelaxedLB();
    }
    
    IloNum getRelaxedUB() const {
...
public:
    ...
    virtual void main(const char* label) ILO_OVERRIDE =0;
...
public:
	...
	virtual void handleConnection(const char* connId, const char* subId, const char* spec) ILO_OVERRIDE =0;
    
	virtual void handleReadElement(const char* connId, const char* name, const char* spec) ILO_OVERRIDE =0;
    
	virtual void handlePublishElement(const char* connId, const char* name, const char* spec) ILO_OVERRIDE =0;
    
	virtual IloBool handleInvoke(const char* name, const char* funcname) ILO_OVERRIDE =0;
    
	virtual void closeConnections() ILO_OVERRIDE {
	}
...
public:
    ...
    virtual IloBool startDecisionExpr(const char* dexprName, IloNum coef, IloNumExprArg expr) ILO_OVERRIDE =0;

    
    virtual IloBool startSum(IloNum coef, IloNumExprArg expr) ILO_OVERRIDE =0;

    
    virtual void addTerm(IloNum coef, IloNumExprArg expr) ILO_OVERRIDE =0;
...
public:
    ...
    virtual IloBool startDecisionExpr(const char* dexprName, IloNum value) ILO_OVERRIDE =0;

    
    virtual IloBool startSum(IloNum coef) ILO_OVERRIDE =0;

    
    virtual void addTerm(IloNum value) ILO_OVERRIDE =0;
...
public:
    ...
    virtual void notifyGenerate(IloOplModel opl, const char*) ILO_OVERRIDE =0;
    
    virtual void notifyStart(IloCplex cplex) ILO_OVERRIDE =0;
    
    virtual void notifyProgress() ILO_OVERRIDE =0;
    
    virtual void notifyEnd(IloCplex cplex) ILO_OVERRIDE =0;
