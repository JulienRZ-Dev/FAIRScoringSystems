...
#define ODMS_CPLEXSERVER "ODMS_CPLEXSERVER"
...
public:
	...
	virtual void info(const char* msgId,const char* arg1=0,const char* arg2=0) ILO_OVERRIDE;
	virtual void warning(const char* msgId,const char* arg1=0,const char* arg2=0) ILO_OVERRIDE;
	virtual void error(const char* msgId,const char* arg1=0,const char* arg2=0) ILO_OVERRIDE;
	virtual void fatal(const char* msgId,const char* arg1=0,const char* arg2=0) ILO_OVERRIDE;
...
public:
	...
	void info(const char* msgId,const char* arg1=0,const char* arg2=0) ILO_OVERRIDE { }
	void warning(const char* msgId,const char* arg1=0,const char* arg2=0) ILO_OVERRIDE { }
	void error(const char* msgId,const char* arg1=0,const char* arg2=0) ILO_OVERRIDE { }
	void fatal(const char* msgId,const char* arg1=0,const char* arg2=0) ILO_OVERRIDE { }
};
