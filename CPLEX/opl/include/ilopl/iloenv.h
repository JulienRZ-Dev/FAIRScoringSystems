...
public:
  ...
  virtual void shareCollection(IloRttiEnvObjectI const *coll) = 0;
  
  virtual void endCollection(IloRttiEnvObjectI const *coll) = 0;
  
  virtual IloBool isSharing(IloRttiEnvObjectI const *) const = 0;

  virtual IloBool isSharingSpecial(IloRttiEnvObjectI const *) const = 0;
  virtual void addDependency(IloRttiEnvObjectI const *obj,
                             IloRttiEnvObjectI const *dep) = 0;
...
public:
  ...
  IloInt operator[] (IloInt i) const{
    IloOplAssert ( i>=0, "Index out of bounds operation: negative index");
    IloOplAssert ( i < _size, "X& IloArray::operator[] (IloInt i) : Out of bounds operation: index superior to size of array");
    return _values[i];
  }
  ...
  void setValue(IloInt index, IloInt value){
    IloOplAssert ( index>=0, "Index out of bounds operation: negative index");
    IloOplAssert ( index < _size, "X& IloArray::operator[] (IloInt i) : Out of bounds operation: index superior to size of array");
    _values[index] = value;
  }
...
public:
  ...
  IloAny operator[] (IloInt i) const{
    IloOplAssert ( i>=0, "Index out of bounds operation: negative index");
    IloOplAssert ( i < _size, "X& IloArray::operator[] (IloAny i) : Out of bounds operation: index superior to size of array");
    return _values[i];
  }
...
public:
  ...
  using IloOplStringHelper::printEscaped;
    virtual void printEscaped(std::ostream& os, const char* chunk) const ILO_OVERRIDE;
};
#endif
