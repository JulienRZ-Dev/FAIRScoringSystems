...
public:
	...
	virtual IloDiscreteDataCollection asDiscreteDataCollection() const =0;
    ...
    virtual IloBool isMap() const =0;
    virtual IloBool isDiscreteDataCollection() const =0;
	...
	virtual const IloOplValue* getInternalValue() const;

        void displayValue(std::ostream& outs) const;
