...
public:
    ...
    void error(IloCP::PresolveException& e, const IloOplLocationI& location, IloBool asWarning =IloFalse);
    ...
    void error(const IloInvalidSequenceConstraintException& e, const IloOplLocationI& location, IloBool asWarning =IloFalse);	
	...
	void error(const IloWrongDExprAccess& e, const IloOplLocationI& location, IloBool asWarning =IloFalse);
  ...
  protected:
    ...
    IloInt getNumberOfErrors() const { return _countErrors;}
    IloInt getNumberOfWarnings() const { return _countWarnings;}
    IloInt getCount() const;
...
public:
  ...
  IloOplDefaultErrorHandlerI(IloEnvI* env, std::ostream& os);

  protected:
  virtual IloBool handleFatal  ( const IloOplMessage& message, const IloOplLocationI& location ) ILO_OVERRIDE;
  virtual IloBool handleError  ( const IloOplMessage& message, const IloOplLocationI& location ) ILO_OVERRIDE;
  virtual IloBool handleWarning( const IloOplMessage& message, const IloOplLocationI& location ) ILO_OVERRIDE;

protected:
  virtual void print( ErrorSeverity severity,
                      const IloOplMessage&  message, const IloOplLocationI& location );
};

class IloOplJSONErrorHandlerI : public IloOplDefaultErrorHandlerI {
  typedef IloOplDefaultErrorHandlerI Super;
  IloOplJSONErrorHandlerI(IloEnv env);
  IloOplJSONErrorHandlerI(IloEnv env, std::ostream& os);
public:
  static IloOplJSONErrorHandlerI* New(IloEnv env);
  static IloOplJSONErrorHandlerI* New(IloEnv env, std::ostream& os);

  virtual void print( ErrorSeverity severity,
                      const IloOplMessage&  message, const IloOplLocationI& location ) ILO_OVERRIDE;
...
ILOOPL_EXPORTEDFUNCTION(std::ostream&) operator<<( std::ostream&  os, const IloOplLocationI&  location);
